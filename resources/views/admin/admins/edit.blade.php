            ...
            <form class="form-horizontal m-t-md" action="{{ route('admins.update',$admin->id) }}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-4">
                        <input class="form-control layer-date"  name="expire_time"  value="{{$admin->expire_time}}" placeholder="YYYY-MM-DD hh:mm:ss" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
...
@section('footer-js')
    <script src="{{loadEdition('/js/plugins/layer/laydate/laydate.js')}}"></script>
@endsection