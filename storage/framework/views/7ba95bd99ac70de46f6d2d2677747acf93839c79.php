                ...
                <form class="form-horizontal m-t-md" action="<?php echo e(route('admins.store')); ?>" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-4">
                            <input class="form-control layer-date" name="expire_time" placeholder="YYYY-MM-DD hh:mm:ss" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
...
<?php $__env->startSection('footer-js'); ?>
    <script src="<?php echo e(loadEdition('/js/plugins/layer/laydate/laydate.js')); ?>"></script>
<?php $__env->stopSection(); ?>
